...
public class ChatB extends JFrame implements KeyListener,ActionListener{ //인터페이스는 다중으로 이용가능하다 아주좋다!
	...
	//나보다 부모가 먼저 태어나야함, 나(chatA)의 부모는 윈도우(JFrame)
		...
		//스타일 적용 
		 ...
		 setBounds(500,150,300,400); //300*400인 크기의 창이 뜨고 x축의위치는 200, y축의 위치는 150
		 setVisible(true);
